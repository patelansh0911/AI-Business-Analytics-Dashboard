...
start_date, end_date = pd.to_datetime(date_range[0]), pd.to_datetime(date_range[1]) # type: ignore
...
with right:
    ...
    cat = f.groupby("Category", as_index=False)["Sales"].sum().sort_values("Sales", ascending=False) # type: ignore
